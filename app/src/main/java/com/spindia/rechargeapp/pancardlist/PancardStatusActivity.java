...
public class PancardStatusActivity extends AppCompatActivity  {
    ...
    private void initView() {
        ...
        webView.loadUrl("https://tin.tin.nsdl.com/tan2/servlet/PanStatusTrack?ST_SEARCH_TYPE=P&ST_SEARCH_OPTION=A&captchFlag=true&ST_ACK_NUM="+receiptno);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Uri result = intent == null || resultCode != PancardStatusActivity.RESULT_OK ? null : intent.getData();
