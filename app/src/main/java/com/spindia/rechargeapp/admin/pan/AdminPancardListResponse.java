...
public class AdminPancardListResponse {
    ...
    @Expose
    private String aadharapiresponse;
    ...
    public String getAadharapiresponse() {
        return aadharapiresponse;
    }

    public void setAadharapiresponse(String aadharapiresponse) {
