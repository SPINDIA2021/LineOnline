...
class UdhyogReportActivity: AppCompatActivity(),  SwipeRefreshLayout.OnRefreshListener {
    lateinit var ivBackBtn: ImageView
    lateinit var mSwipeRefresh:SwipeRefreshLayout
    lateinit var progress_bar: RelativeLayout
    lateinit var udhyoglistResponse: UdhyogResponse
    lateinit var udhyogAdapter: UdhyogListAdapter
    var udhyogListModalArrayList = ArrayList<UdhyogResponse>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tvTitle.setText("Aadhar Udhyog List")
        ...
        pd = ProgressDialog(this@UdhyogReportActivity)
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    ...
                    if (mInterstitialAd != null) {
                        mInterstitialAd!!.show(this@UdhyogReportActivity)
                    } else {
        ...
        mSwipeRefresh.post(Runnable {
            ...
            udhyogListModalArrayList.clear()
            callServiceGetGSTList()
    ...
    private fun callServiceGetGSTList() {
        ...
        val formtype: RequestBody = createPartFromString("udhyog")



        val call = apiService.callGetUdhyogListService(rtid,formtype)


        //making the call to generate checksum
        call.enqueue(object : Callback<BaseUdhyogResponse> {
            override fun onResponse(
                call: Call<BaseUdhyogResponse>,
                response: Response<BaseUdhyogResponse>
            ) {
                progress_bar.visibility = View.GONE
                if (response.body()!!.status == true) {
                    udhyogListModalArrayList= response.body()!!.udhyogResponse
                    rvPancardHistory.apply {

                        layoutManager = LinearLayoutManager(this@UdhyogReportActivity)
                        udhyogAdapter = UdhyogListAdapter(
                            context, udhyogListModalArrayList, retryClick,editClick, statusClick,pdfClick,panInfoClick
                        )
                        rvPancardHistory.adapter = udhyogAdapter
                    }
                } else {
                    Toast.makeText(
                        this@UdhyogReportActivity,
            ...
            override fun onFailure(call: Call<BaseUdhyogResponse>, t: Throwable) {
                progress_bar.visibility = View.GONE
                // callServiceFalse(mobileNo);
                Toast.makeText(this@UdhyogReportActivity, t.message, Toast.LENGTH_SHORT).show()
            }
        })
    }
