...
class GSTListAdapter(
    context: Context?,
    pancardModalList: ArrayList<GSTResponse>,
    ...
    private var pancardModalList: List<GSTResponse>
    ...
    override fun onCreateViewHolder(
        ...
        val listItem: View =
            layoutInflater.inflate(R.layout.layout_gstregistration, parent, false)
    ...
    override fun onBindViewHolder(
        ...
        val pancardModal: GSTResponse =
            pancardModalList[position]

        holder.text_owner.setText("Owner: "+pancardModal.businessOwner)
       // holder.tv_paystatus.setText(pancardModal.paymentstatus)
        holder.text_mobile.setText("Mob No: "+pancardModal.mobileNo)
        holder.text_panNo.setText("PAN No: "+pancardModal.panNo)

        holder.text_emailid.setText("Email: "+pancardModal.email)
        holder.tvTxnDate.setText(pancardModal.createat)
        holder.tvCompanyName.setText(pancardModal.companyName)
...
*/
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var text_mobile: TextView
        var text_panNo: TextView
        var text_emailid: TextView
       ...
       // var btnpanInfo: Button
        ...
        init {
            ...
            text_emailid = itemView.findViewById(R.id.text_emailid)
