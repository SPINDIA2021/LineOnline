...
import com.spindia.rechargeapp.recharge_services.OfferDetailsAdapter
import com.spindia.rechargeapp.recharge_services.OfferInnerModelClss
import java.util.*


class MainDTHOfferDetailsAdapter(
    context: Context?,
    ...
    RecyclerView.Adapter<MainDTHOfferDetailsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(
        ...
        holder.rvOffers.apply {
            ...
            offerDetailsAdapter = DTHOfferDetailsAdapter(
