...
import com.spindia.rechargeapp.main_controller.VolleySingleton
import com.spindia.rechargeapp.network_calls.AppApiUrl.AEPSCOMMISSION_HISTORY
import com.spindia.rechargeapp.network_calls.AppApiUrl.AEPSPAYOUT_HISTORY
import com.spindia.rechargeapp.network_calls.AppApiUrl.AEPS_BANK_LIST
import com.spindia.rechargeapp.network_calls.AppApiUrl.AEPS_COMMISIONSLAB_URL
import com.spindia.rechargeapp.network_calls.AppApiUrl.AEPS_HISTORY
import com.spindia.rechargeapp.network_calls.AppApiUrl.AEPS_PAYOUT
import com.spindia.rechargeapp.network_calls.AppApiUrl.AEPS_TRANSACTION
import com.spindia.rechargeapp.network_calls.AppApiUrl.BROWSE_PLANS
import com.spindia.rechargeapp.network_calls.AppApiUrl.BROWSE_PLANS_DTH
import com.spindia.rechargeapp.network_calls.AppApiUrl.BUY_PRODUCT
import com.spindia.rechargeapp.network_calls.AppApiUrl.BUY_PRODUCT_AND_SERVICE
import com.spindia.rechargeapp.network_calls.AppApiUrl.BUY_SERVICE
import com.spindia.rechargeapp.network_calls.AppApiUrl.CASH_DEPOSIT_WITH_OTP
import com.spindia.rechargeapp.network_calls.AppApiUrl.CHANGE_PASWORD
import com.spindia.rechargeapp.network_calls.AppApiUrl.CHANGE_PIN
import com.spindia.rechargeapp.network_calls.AppApiUrl.CHECKSAME_FUNDTRANSFER
import com.spindia.rechargeapp.network_calls.AppApiUrl.CHECK_IF_SAME_RECHARGE
import com.spindia.rechargeapp.network_calls.AppApiUrl.CHECK_KYC_STATUS
import com.spindia.rechargeapp.network_calls.AppApiUrl.CHECK_STATUS
import com.spindia.rechargeapp.network_calls.AppApiUrl.CIRCLE
import com.spindia.rechargeapp.network_calls.AppApiUrl.COMMISION_REPORT_URL
import com.spindia.rechargeapp.network_calls.AppApiUrl.DELETE_RECIPIENT
import com.spindia.rechargeapp.network_calls.AppApiUrl.DISSPUTE_HISTORY
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_ADD_BENFICIARY
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_BANK_LIST
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_COMMISIONSLAB_URL
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_HISTORY
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_LOGIN
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_REGISTER
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_SENDOTP
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_TRANSACTION
import com.spindia.rechargeapp.network_calls.AppApiUrl.DMT_VIEW_BENIFICIARY
import com.spindia.rechargeapp.network_calls.AppApiUrl.DUMMY_PID
import com.spindia.rechargeapp.network_calls.AppApiUrl.EKYC
import com.spindia.rechargeapp.network_calls.AppApiUrl.FORGETPIN
import com.spindia.rechargeapp.network_calls.AppApiUrl.FORGOT_PASS
import com.spindia.rechargeapp.network_calls.AppApiUrl.FUND_CREDIT
import com.spindia.rechargeapp.network_calls.AppApiUrl.FUND_DEBIT
import com.spindia.rechargeapp.network_calls.AppApiUrl.FUND_MYREQUEST
import com.spindia.rechargeapp.network_calls.AppApiUrl.FUND_REQUEST_URL
import com.spindia.rechargeapp.network_calls.AppApiUrl.FUND_TRANSFER
import com.spindia.rechargeapp.network_calls.AppApiUrl.GETBILLDETAILS
import com.spindia.rechargeapp.network_calls.AppApiUrl.GETFORGOTOTP
import com.spindia.rechargeapp.network_calls.AppApiUrl.GETPINOTP
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_AEPS_BALANCE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_AEPS_CHARGE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_BALANCE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_CHARGE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_DASHBOARD
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_DMT_SERVICE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_ELECTIRCITY_OPERATORS
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_OPERATORS
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_PAYOUT_DETAILS
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_PRODUCTS
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_PRODUCT_AND_SERVICE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_PROFILE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_SERVICE_AMOUNT
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_SERVICE_STATUS
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_SINGLE_PRODUCT_AND_SERVICE
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_SUPPORT
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_UPIDETAILS
import com.spindia.rechargeapp.network_calls.AppApiUrl.GET_USER_ID
import com.spindia.rechargeapp.network_calls.AppApiUrl.KYC_ONBOARDING
import com.spindia.rechargeapp.network_calls.AppApiUrl.LEDGER_REPORT
import com.spindia.rechargeapp.network_calls.AppApiUrl.LOGIN_BY_PASSWORD
import com.spindia.rechargeapp.network_calls.AppApiUrl.LOGOUT_USER
import com.spindia.rechargeapp.network_calls.AppApiUrl.MICRO_ATM_LOGIN
import com.spindia.rechargeapp.network_calls.AppApiUrl.MICRO_ATM_TRANSACTION
import com.spindia.rechargeapp.network_calls.AppApiUrl.NEWUSER_URL
import com.spindia.rechargeapp.network_calls.AppApiUrl.NEW_DISTRIBUTOR_URL
import com.spindia.rechargeapp.network_calls.AppApiUrl.NOTE
import com.spindia.rechargeapp.network_calls.AppApiUrl.OFFER_POPUP
import com.spindia.rechargeapp.network_calls.AppApiUrl.PRODUCT_SERVICES_HISTORY
import com.spindia.rechargeapp.network_calls.AppApiUrl.RAISE_DISPUTE
import com.spindia.rechargeapp.network_calls.AppApiUrl.RECHARGE
import com.spindia.rechargeapp.network_calls.AppApiUrl.RECHARGE_HISTORY
import com.spindia.rechargeapp.network_calls.AppApiUrl.RECHARGE_HISTORY_BY_DATE
import com.spindia.rechargeapp.network_calls.AppApiUrl.RECHARGE_HISTORY_BY_MOBILE
import com.spindia.rechargeapp.network_calls.AppApiUrl.REGISTER
import com.spindia.rechargeapp.network_calls.AppApiUrl.RESEND_EKYC_OTP
import com.spindia.rechargeapp.network_calls.AppApiUrl.STATE_LIST
import com.spindia.rechargeapp.network_calls.AppApiUrl.UPDATE_WALLET
import com.spindia.rechargeapp.network_calls.AppApiUrl.USER_DAYBOOK
import com.spindia.rechargeapp.network_calls.AppApiUrl.USER_LIST
import com.spindia.rechargeapp.network_calls.AppApiUrl.USER_PAYOUT_BANK
import com.spindia.rechargeapp.network_calls.AppApiUrl.USER_SEARCH
import com.spindia.rechargeapp.network_calls.AppApiUrl.VALIDATE_CASH_DEPOSIT_OTP
import com.spindia.rechargeapp.network_calls.AppApiUrl.VALIDATE_EKYC_OTP
import com.spindia.rechargeapp.network_calls.AppApiUrl.VERIFY_BANK
import com.spindia.rechargeapp.network_calls.AppApiUrl.VERIFY_PIN
import com.spindia.rechargeapp.utils.AppCommonMethods
import com.spindia.rechargeapp.utils.AppConstants
import com.spindia.rechargeapp.utils.AppConstants.Companion.AADHAR_NUM
import com.spindia.rechargeapp.utils.AppConstants.Companion.ADDRESS
import com.spindia.rechargeapp.utils.AppConstants.Companion.AMOUNT
import com.spindia.rechargeapp.utils.AppConstants.Companion.API_KEY
import com.spindia.rechargeapp.utils.AppConstants.Companion.BASIC
import com.spindia.rechargeapp.utils.AppConstants.Companion.BASIC_TOKEN
import com.spindia.rechargeapp.utils.AppConstants.Companion.CUS_ID
import com.spindia.rechargeapp.utils.AppConstants.Companion.CUS_MOBILE_API
import com.spindia.rechargeapp.utils.AppConstants.Companion.CUS_TYPE
import com.spindia.rechargeapp.utils.AppConstants.Companion.CUS_UPI
import com.spindia.rechargeapp.utils.AppConstants.Companion.DATE
import com.spindia.rechargeapp.utils.AppConstants.Companion.DEVICE_ID
import com.spindia.rechargeapp.utils.AppConstants.Companion.DEVICE_NAME
import com.spindia.rechargeapp.utils.AppConstants.Companion.EMAIL
import com.spindia.rechargeapp.utils.AppConstants.Companion.FORM_URL_ENCODED
import com.spindia.rechargeapp.utils.AppConstants.Companion.FROM_DATE
import com.spindia.rechargeapp.utils.AppConstants.Companion.MOBILE
import com.spindia.rechargeapp.utils.AppConstants.Companion.MOBILE_RECHARGE
import com.spindia.rechargeapp.utils.AppConstants.Companion.OPERATOR
import com.spindia.rechargeapp.utils.AppConstants.Companion.OPERATOR_TYPE
import com.spindia.rechargeapp.utils.AppConstants.Companion.PASSWORD
import com.spindia.rechargeapp.utils.AppConstants.Companion.PIN
import com.spindia.rechargeapp.utils.AppConstants.Companion.REC_MOBILE
import com.spindia.rechargeapp.utils.AppConstants.Companion.TOKEN
import com.spindia.rechargeapp.utils.AppConstants.Companion.TO_DATE
import com.spindia.rechargeapp.utils.AppConstants.Companion.USER_NAME
import com.spindia.rechargeapp.utils.AppPrefs
import com.spindia.rechargeapp.utils.AppPrefs.putStringPref
...
class AppApiCalls(
        ...
        val getRequest: StringRequest =
            object : StringRequest(
                ...
                override fun getParams(): Map<String, String> {
                    val jsonObject: MutableMap<String, String> =
                        HashMap()
                    jsonObject[CUS_UPI] = cus_upi
                    jsonObject[CUS_ID] = cus_id
                    jsonObject["mobile"] = rec_mobile
                    jsonObject[AMOUNT] = amount
                    jsonObject[OPERATOR] = operator
                    jsonObject[CUS_TYPE] = cus_type
                    jsonObject["usermobile"] = user_mobile
    ...
    fun mobileOffers(
        mobile: String, operator: String, circle_code: String
    ) {
